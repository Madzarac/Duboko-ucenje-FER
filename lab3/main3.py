...
def main(args):
    ...
    model = GRUModel(embedding_dim=300, hidden_dim=args.hidden_dim, num_layers=args.num_layers, embeddings=embedding, freeze=True, bidirectional=args.bidirectional).to(device)
