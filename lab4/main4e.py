...
if __name__ == '__main__':
    ...
    ds_repr = MNISTMetricDataset(mnist_download_root, split='traineval')
    ...
    for epoch in range(epochs):
        ...
        if EVAL_ON_TEST or EVAL_ON_TRAIN:
            ...
            representations = compute_representations(model, DataLoader(ds_repr, batch_size=1), num_classes, emb_size, device)
        if EVAL_ON_TRAIN:
    ...
    torch.save(model.state_dict(), "metric_model.pth")
    print("Model saved to metric_model.pth")